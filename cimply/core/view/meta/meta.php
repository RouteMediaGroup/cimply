...
namespace Cimply\Core\View\Meta {
    ...
    class Meta {
        ...
        function KeywordsDE($keywords) {
            $this->keywords_de = $keywords;
        }

        function KeywordsEN($keywords) {
            $this->keywords_en = $keywords;
        }
